              ...
              <div class="row">
                ...
                <div class="col offset-l2 offset-m2 s12 m8 l6 ">
                  <div id="profile-card" class="card">
                    ...
                    <span class="card-title activator red-text text-darken-4">Invalid Username/Password </span>
                      <span class="card-title activator grey-text text-darken-4">Login </span>
                      
                      <div class="row">
                        <form class="col s12" action="query/login_check.php" method="post">
                          <div class="row">
                            ...
                            <div class="row">
                             <div class="input-field col s12">
                                  ...
                                  <input id="pasword" type="password" name="password" class="validate">
