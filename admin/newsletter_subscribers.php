...
<html lang="en">
  <head>
    ...
    <title>Newsletter Subscribers | Arya Real EState</title>
    <!-- Favicons-->
        ...
        <!-- //////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="divider"></div>
            	...
            	<div class="col s12 card" >
                    <div class="row">
                        <div class="col s10" >
                            <h4 class="blue-grey-text center">Newsletter Subscribers</h4>
                        </div>
                        <div class="col s2" >
                        <?php
							include('database_connection.php');
							
							$sql="SELECT count(id) as num FROM subscribers ";
              ...
              <div class="row">
                <div class="col s12  z-index-2">
                  <table class="striped centered" >
                    ...
                    $sql="SELECT * FROM subscribers order by date desc LIMIT $start_from, $limit";
                    $result=mysqli_query($con,$sql);
                   ...
                   <?php  
						$sql = "SELECT COUNT(id) FROM subscribers";  
						...
						if($page!=1)
						{
							...
							echo '<li class="waves-effect"><a href="newsletter_subscribers.php?page='.$previous_page.'"><i class="material-icons">chevron_left</i></a></li>';			
						}
						else
						{
						...
						if($page==$i)
								{
									 echo' <li class="active"><a class="center" href="newsletter_subscribers.php?page='.$i.'">'.$i.'</li> ';
									
								}
								else
								{
									 echo' <li class=""><a  href="newsletter_subscribers.php?page='.$i.'">'.$i.'</li> ';
							...
							echo '<li class=" waves-effect"><a href="newsletter_subscribers.php?page='.$next_page.'"><i class="material-icons">chevron_right</i></a></li>
						 </ul>';
							}
						mysqli_close($con); 
					?>
