            	...
            	<div class="col s12 card" >
                    <div class="row">
                        ...
                        <div class="col s8 center" >
                             <h5 class="blue-grey-text" id="akhil">Edit Job</h5>
                        </div>
              ...
              <div class="row ">
                <div class="col s12 ">
                  <div class="row">
                  	...
                  	<form  class="job_form" action="query/update_job.php" method="post" >
                          <div class="row">
                            ...
                            <div class="input-field col s12 m6 l4">
                            	<i class="material-icons  prefix ">star</i>
                                  ...
                                  <input id="job_id" type="text" name="job_id"  class="validate" readonly="readonly" required  value=" <?php echo $job_id; ?>" >
                                  <input style="display:none" id="page_no" type="text" name="page_no"  class="validate" readonly="readonly" required  value=" <?php echo trim($page); ?>" >
                            </div>
                            <div class="input-field col s12 m6 l4">
                            	<i class="material-icons  prefix">work</i>
                                  <label for="post_name">Post / Designation Name</label>
                                  <input id="post_name" type="text" name="post_name" class="validate" required  value=" <?php echo $r['post_name']; ?>" >
                            </div>
                            <div class="input-field col s12 m6 l4">
                            	<i class="material-icons  prefix">location_on</i>
                                  <label for="city">City</label>
                                  <input id="city" type="text" name="city" class="validate" required value=" <?php echo $r['city']; ?>">
                            </div>
                          </div>
                           <div class="row">
                            <div class="input-field col s12 m6 l4">
                                  ...
                                  <input id="post_date" type="text" name="post_date"  class="validate datepicker" value=" <?php echo $r['post_date']; ?>"  required >
                            </div>
                          
                             <div class="input-field col s12 m6 l4">
                             	<i class="material-icons  prefix">date_range</i>
                             	  <label for="expire_date">Job Expire Date</label>
                                  <input id="expire_date" type="text" name="expire_date" class="validate datepicker" value=" <?php echo $r['last_date']; ?>" required>
                             ...
                             <div class="input-field col s12 m4 l3">
                                <button type="submit" id="mainsbmt" class="btn waves-effect waves-light blue modal-trigger" data-target="modal1"  ><i class="material-icons right">edit</i>Edit</button>
                                <!-- Modal Structure -->
                              <div id="modal1" class="modal">
                                <div class="modal-content">
                                  <h4>Edit Job?</h4>
                                  <p>Job Id: <?php echo $job_id;?>  </p>
                                  <p>City: <?php echo $r['city']; mysqli_close($con) ;?>  </p>
                                </div>
                                <div class="modal-footer">
                                  <button type="submit" id="btnsubmit"class=" modal-close waves-effect waves-green btn-flat">Yes</button>
