...
<html lang="en">
  <head>
    ...
    <title> Visitors | Arya Real EState</title>
    <!-- Favicons-->
            ...
            <ul class="left">
              <li>
                <h1 class="logo-wrapper">
                  <a href="dashboard.html" class="brand-logo darken-1">
        ...
        <!-- //////////////////////////////////////////////////////////////////////////// -->
            ...
            <div class="divider"></div>
            	...
            	<div class="col s12 card" >
                    <div class="row">
                        <div class="col s10" >
                            <h5 class="blue-grey-text center">People who contacted you</h5>
                        </div>
                        <div class="col s2" >
                        <?php
                    
							include('database_connection.php');
							$sql="SELECT count(id) as num FROM contact_us ";
							$result=mysqli_query($con,$sql);
							$r=mysqli_fetch_assoc($result);
							
							$sqlu="SELECT count(id) as numu FROM contact_us where status='Unattended' ";
							$resultu=mysqli_query($con,$sqlu);
							$ru=mysqli_fetch_assoc($resultu);
							
							$sqla="SELECT count(id) as numa FROM contact_us where status='Attended' ";
                ...
                <div class="col s8 padding-1 ">
                	<div class="header-search-wrapper ">
                    	 <i class="material-icons left">search</i>
           				 <input type="text" name="Search" class="header-search-input"  id="search_field" placeholder="Search by anything">
          			</div>
              ...
              <div class="row">
                <div class="col s12  z-index-2">
                  <table class="striped centered" >
                    ...
                    $sql="SELECT * FROM contact_us order by date desc LIMIT $start_from, $limit";
                    $result=mysqli_query($con,$sql);
                  ...
                  <?php  
						$sql = "SELECT COUNT(id) FROM contact_us";  
						...
						if($page!=1)
						{
							...
							echo '<li class="waves-effect"><a href="visitors.php?page='.$previous_page.'"><i class="material-icons">chevron_left</i></a></li>';			
						}
						else
						{
						...
						if($page==$i)
								{
									 echo' <li class="active"><a class="center" href="visitors.php?page='.$i.'">'.$i.'</li> ';
									
								}
								else
								{
									 echo' <li class=""><a  href="visitors.php?page='.$i.'">'.$i.'</li> ';
							...
							echo '<li class=" waves-effect"><a href="visitors.php?page='.$next_page.'"><i class="material-icons">chevron_right</i></a></li>
						 </ul>';
							}
						mysqli_close($con); 
					?>
